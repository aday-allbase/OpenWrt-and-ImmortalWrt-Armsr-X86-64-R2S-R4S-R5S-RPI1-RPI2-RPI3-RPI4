...
# Selecting default packages
    ...
    # misc
    PACKAGES="$PACKAGES zram-swap adb parted losetup resize2fs luci luci-ssl luci-app-ramfree htop bash curl wget wget-ssl tar unzip unrar gzip jq luci-app-ttyd nano httping screen openssh-sftp-server"
